...
export default [
	...
	// #region 邻居
	{
		...
		entries: [
			...
			},
			{
				...
				avatar: 'https://shu560.cn/_astro/avatar.BcAu2wMi_1Ilpva.avif',
				date: '2026-08-11',
				comment: '又一个全栈大佬',
			},
			{
	...
	// #region 小南梁
	{
		...
		entries: [
			...
			{
				author: 'Inui Sajuna',
				sitenick: 'Inui Sajuna',
				title: 'Sajuna的小站',
				desc: '看见的话你要对我负责的',
				link: 'https://blog.sajunan.cn/',
				icon: 'https://blog.sajunan.cn/_astro/avatar.2uVWmEp4_Z2vFDRn.webp',
				avatar: 'https://blog.sajunan.cn/_astro/avatar.2uVWmEp4_Z2vFDRn.webp',
				date: '2026-08-11',
				comment: '密码学xnn',
			},
		],
